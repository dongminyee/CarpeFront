...
const API_BASE = 'https://effective-space-waffle-46x5j4xvv56fqvp5-8080.app.github.dev/api/song';
...
async function editSong(buttonElement, videoId) {
    ...
    Swal.fire({
       ...
       cancelButtonText: '취소',
        ...
        return { videoId: videoId, title: inputTitle, artist: inputArtist, generation: inputGeneration,
        ...
        if (result.isConfirmed) {
            ...
            fetch(`https://effective-space-waffle-46x5j4xvv56fqvp5-8080.app.github.dev/api/song/patch?${params.toString()}`, {
                method: 'PATCH'
            })
            .then(response => {
                if (response.ok) {
